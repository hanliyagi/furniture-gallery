export const CATALOG_CHANGELOG = `# Furniture JSON Catalog Changelog
...
- Each Variant was rebuilt with the React Three Fiber model renderer in front, side, and top views and checked with bound projections.
- The full generated audit is included as \`CATALOG_AUDIT.md\` in this archive.
`;
